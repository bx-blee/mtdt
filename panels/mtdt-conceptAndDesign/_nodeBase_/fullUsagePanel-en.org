...
** B|
* +
* Pkgs Base: file:/bisos/git/bxRepos/blee/mcdt   -- To be replaced by mtdt
...
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Concept of Mailing -- A Mail Template" :anchor "" :extraInfo ""
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Concept of Mailing -- A Mail Template:* |]]    [[elisp:(org-shifttab)][<)]] E|
####+END
** +
